...
public class TourismBelanjaMaps extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbarShoppingMap = findViewById(R.id.toolbar_shopping_map);
        setSupportActionBar(toolbarShoppingMap);
    }
        ...
        shoppingMapQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot dsNature : dataSnapshot.getChildren()){
                    ...
                    LatLng shoppingPlaceLoc = new LatLng(latTourism, lngTourism);
