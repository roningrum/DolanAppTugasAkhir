...
public class HistoryViewHolder extends RecyclerView.ViewHolder {
    ...
    public void showHistoryTourismData(CategoryItem categoryItem, double latitude, double longitude) {
...
//        float jarakMeter = loc1.distanceTo(loc2);
        ...
        nameHisToryTourismItem.setText(categoryItem.getName_tourism());
        locationHisToryTourismItem.setText(categoryItem.getLocation_tourism());
        distanceHisToryTourismItem.setText(distanceFormat + " KM");
        Glide.with(itemView.getContext()).load(categoryItem.getUrl_photo()).into(hisToryTourismpic);
    }
