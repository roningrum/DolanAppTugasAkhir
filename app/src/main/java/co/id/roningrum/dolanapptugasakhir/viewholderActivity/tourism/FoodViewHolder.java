...
public class FoodViewHolder extends RecyclerView.ViewHolder {
    ...
    public void showFoodTourismData(Tourism tourism, double latitude, double longitude) {
...
//        float jarakKM = jarakMeter / 1000;
        ...
        nameFoodTourism.setText(tourism.getName_tourism());
        locationFoodTourism.setText(tourism.getLocation_tourism());
        distanceFoodTourism.setText(distanceFormat + " km");
        Glide.with(itemView.getContext()).load(tourism.getUrl_photo()).into(foodTourismPic);
    }
