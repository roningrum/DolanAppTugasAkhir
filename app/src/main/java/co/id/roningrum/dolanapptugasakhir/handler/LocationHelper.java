...
import co.id.roningrum.dolanapptugasakhir.util.PermissionResultCallback;
import co.id.roningrum.dolanapptugasakhir.util.PermissionUtils;
...
public class LocationHelper implements PermissionResultCallback {
    ...
    {
        permissionUtils.onRequestPermissionResults(requestCode,permissions,grantResults);
    }
