...
public class FoodViewHolder extends RecyclerView.ViewHolder {
    ...
    //interface
    private FoodViewHolder.ClickListener categoryOnClick;
    ...
    public void showFoodTourismData(TourismItem tourismItem, double latitude, double longitude) {
...
//        float jarakKM = jarakMeter / 1000;
        ...
        nameFoodTourism.setText(tourismItem.getName_tourism());
        locationFoodTourism.setText(tourismItem.getLocation_tourism());
        distanceFoodTourism.setText(distanceFormat + " km");
        Glide.with(itemView.getContext()).load(tourismItem.getUrl_photo()).into(foodTourismPic);
    }
