        ...
        educationMapQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dsNature : dataSnapshot.getChildren()) {
                    ...
                    educationPlaceMap.addMarker(new MarkerOptions().position(naturePlaceLoc).icon(getBitmapDescriptor()).title(tourismItem.getName_tourism()).snippet(tourismItem.getLocation_tourism()));
                }
            }
