...
public class ReligiViewHolder extends RecyclerView.ViewHolder {
    ...
    public void showReligiTourismData(Tourism tourism, double latitude, double longitude) {
...
//        float jarakKM = jarakMeter / 1000;
        ...
        name_religi_tourisms.setText(tourism.getName_tourism());
        location_religi_tourisms.setText(tourism.getLocation_tourism());
        distance_religi_tourisms.setText(distanceFormat + " km");
        Glide.with(itemView.getContext()).load(tourism.getUrl_photo()).into(tourism_religi_pic);
    }
