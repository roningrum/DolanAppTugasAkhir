...
public class NatureCategoryActivity extends AppCompatActivity {
    ...
    private DatabaseReference natureCategoryDB;
    private Query query;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarNature = findViewById(R.id.toolbar_top_nature);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void showData() {
        if (havePermission()) {
            natureCategoryDB = FirebaseDatabase.getInstance().getReference();
            query = natureCategoryDB.child("Tourism").orderByChild("category_tourism").equalTo("alam");
