...
public class TourismViewHolder extends RecyclerView.ViewHolder {
    ...
    //interface
    private TourismViewHolder.ClickListener categoryOnClick;
...
//    }
    ...
    public void showEducationTourismData(Tourism tourism, double latitude, double longitude) {
...
//        float jarakKM = jarakMeter / 1000;
        ...
        nameEducationTourism.setText(tourism.getName_tourism());
        locationEducationTourism.setText(tourism.getLocation_tourism());
        distanceEducationTourism.setText(distanceFormat + " km");
        Glide.with(itemView.getContext()).load(tourism.getUrl_photo()).into(educationTourismPic);
    }

    public void setOnClickListener(TourismViewHolder.ClickListener clickListener) {
