...
//    }
    ...
    public void showRecreationTourismData(Tourism tourism, double latitude, double longitude) {
...
//        float jarakKM = jarakMeter / 1000;
        ...
        name_recreation_tourisms.setText(tourism.getName_tourism());
        location_recreation_tourisms.setText(tourism.getLocation_tourism());
        distance_recreation_tourisms.setText("" + distanceFormat + " km");
        Glide.with(itemView.getContext()).load(tourism.getUrl_photo()).into(tourism_recreation_pic);
    }
