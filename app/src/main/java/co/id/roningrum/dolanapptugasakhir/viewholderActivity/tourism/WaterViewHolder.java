...
public class WaterViewHolder extends RecyclerView.ViewHolder {
    ...
    public void showWaterTourismData(Tourism tourism, double latitude, double longitude) {
...
//        float jarakKM = jarakMeter / 1000;
        ...
        name_water_tourism.setText(tourism.getName_tourism());
        location_water_tourism.setText(tourism.getLocation_tourism());
        distance_waterTourism.setText(distanceFormat + " km");
        Glide.with(itemView.getContext()).load(tourism.getUrl_photo()).into(water_tourism_pic);
    }
