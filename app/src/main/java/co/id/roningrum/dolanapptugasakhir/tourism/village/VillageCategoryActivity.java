...
import co.id.roningrum.dolanapptugasakhir.tourism.shopping.DetailShoppingActivity;
import co.id.roningrum.dolanapptugasakhir.tourism.shopping.ShoppingCategoryActivity;
import co.id.roningrum.dolanapptugasakhir.tourism.shopping.ShoppingCategoryMap;

public class VillageCategoryActivity extends AppCompatActivity {
    private RecyclerView rvVillageList;
    private Toolbar toolbarVillage;
    ...
    private DatabaseReference villageCategoryDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarVillage = findViewById(R.id.toolbar_top_village);
    ...
    private void showData() {
        if (havePermission()) {
            villageCategoryDB = FirebaseDatabase.getInstance().getReference();
            villageQuery= villageCategoryDB.child("Tourism").orderByChild("category_tourism").equalTo("desa");
