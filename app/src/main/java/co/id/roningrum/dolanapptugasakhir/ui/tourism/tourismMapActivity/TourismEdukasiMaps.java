...
public class TourismEdukasiMaps extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbarEducationMap = findViewById(R.id.toolbar_education_map);
        setSupportActionBar(toolbarEducationMap);
    }
        ...
        educationMapQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dsNature : dataSnapshot.getChildren()) {
                    ...
                    LatLng educationPlaceLoc = new LatLng(latNature, lngNature);
